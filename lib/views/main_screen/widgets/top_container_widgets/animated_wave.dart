...
class _MyAnimatedWavesCurves extends State<AnimatedWave>
    ...
    return Transform.rotate(
      ...
      child: Stack(//stack helps to overlaps widgets
        ...
        Positioned(
          ...
          right: animation?.value, //value of right from animation
          // controller
          child: ClipPath(
        ...
        Positioned(
          //helps to position widget where ever we want
          bottom: 0, //position at the bottom
          left: animation?.value, //value of left from animation
          // controller
          child: ClipPath(
            clipper: MyWaveClipper(), //applying our custom clipper
            child: Opacity(
